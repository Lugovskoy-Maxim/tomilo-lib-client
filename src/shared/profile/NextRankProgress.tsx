...
export default function NextRankProgress({ userProfile, onShowStats }: NextRankProgressProps) {
  ...
  const { progressPercent, nextLevelExp, currentRank, motivationalMessage } = useMemo(() => {
      ...
      >
        <div className="flex items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-[var(--foreground)]">Прогресс ранга</h3>
