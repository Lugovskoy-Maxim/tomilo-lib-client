...
export function generateDynamicSEOMetadata(filters: Filters) {
  ...
  } else if (filters.genres.length > 0 || filters.types.length > 0 || filters.status.length > 0 || filters.releaseYears.length > 0) {
    const filterParts = [];
  ...
  let description = "Полный каталог манги, манхвы, маньхуа и комиксов для чтения онлайн. Поиск по жанрам, годам выпуска, статусу и типу. Удобная навигация и регулярные обновления.";
  ...
  let keywords = "каталог манги, манхва, маньхуа, комиксы, онлайн чтение, поиск тайтлов, жанры манги";
  ...
  if (filters.releaseYears.length > 0) url.searchParams.set("releaseYears", filters.releaseYears.join(","));
