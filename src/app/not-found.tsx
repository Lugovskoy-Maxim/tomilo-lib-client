...
export default function NotFound() {
  ...
  return (
    <div className="h-[calc(100vh-var(--header-height))] min-h-[calc(100vh-var(--header-height))] bg-gradient-to-br from-[var(--background)] to-[var(--secondary)] flex items-center justify-center">
