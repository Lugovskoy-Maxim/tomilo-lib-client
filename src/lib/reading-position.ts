 ...
 */
export const saveReadingPosition = (titleId: string, chapterId: string, page: number): void => {
 ...
 */
export const getReadingPosition = (titleId: string, chapterId: string): ReadingPosition | null => {
 ...
 */
export const createDebouncedSave = (saveFn: (page: number) => void, delay: number = 1500) => {
 ...
 */
export const createScrollDebounce = (callback: () => void, delay: number = 100) => {
  let timeoutId: NodeJS.Timeout;
