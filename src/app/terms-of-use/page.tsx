      ...
      <div className="w-full mx-auto px-2 min-[360px]:px-3 py-3 sm:px-4 sm:py-6 max-w-6xl min-w-0 overflow-x-hidden pb-12 sm:pb-16">
        ...
        <div className="content-card mb-8">
          <div className="space-y-8">
            ...
            <div id="definitions">
              <h2 className="content-card-section-title">{currentContent.sections.definitions.title}</h2>
            ...
            <div id="agreement">
              <h2 className="content-card-section-title">{currentContent.sections.agreement.title}</h2>
              <ul className="content-card-body list-disc list-inside space-y-1">
            ...
            <div id="adminRights">
              <h2 className="content-card-section-title">{currentContent.sections.adminRights.title}</h2>
              <ul className="content-card-body list-disc list-inside space-y-1">
            ...
            <div id="liability">
              <h2 className="content-card-section-title">{currentContent.sections.liability.title}</h2>
              <ul className="content-card-body list-disc list-inside space-y-1">
            ...
            <div id="other">
              <h2 className="content-card-section-title">{currentContent.sections.other.title}</h2>
              <ul className="content-card-body list-disc list-inside space-y-1">
