    ...
    <>
      ...
      <main className="min-h-screen flex flex-col bg-[var(--background)] min-w-0 overflow-x-hidden">
        ...
        <div className="content-page-hero text-center mb-10">
          <h1 className="text-2xl sm:text-4xl font-bold text-[var(--foreground)] mb-3 tracking-tight leading-tight">О платформе TOMILO-LIB</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <section className="content-card bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 sm:p-8 sm:rounded-2xl">
            <h2 className="content-card-section-title flex items-center gap-2 text-xl font-semibold text-[var(--foreground)] mb-4 [&_svg]:text-[var(--primary)] [&_svg]:shrink-0">Наша миссия</h2>
          ...
          <section className="content-card bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 sm:p-8 sm:rounded-2xl">
            <h2 className="content-card-section-title flex items-center gap-2 text-xl font-semibold text-[var(--foreground)] mb-4 [&_svg]:text-[var(--primary)] [&_svg]:shrink-0">Для кого платформа</h2>
            <p className="content-card-body text-[var(--muted-foreground)] leading-relaxed">
          ...
          <section className="content-card bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 sm:p-8 sm:rounded-2xl">
            <h2 className="content-card-section-title flex items-center gap-2 text-xl font-semibold text-[var(--foreground)] mb-4 [&_svg]:text-[var(--primary)] [&_svg]:shrink-0">Что уже доступно</h2>
          ...
          <section className="content-card bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 sm:p-8 sm:rounded-2xl">
            <h2 className="content-card-section-title flex items-center gap-2 text-xl font-semibold text-[var(--foreground)] mb-4 [&_svg]:text-[var(--primary)] [&_svg]:shrink-0">Как мы развиваемся</h2>
            <p className="content-card-body text-[var(--muted-foreground)] leading-relaxed">
          ...
          <section className="content-card bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 sm:p-8 sm:rounded-2xl lg:col-span-2">
            ...
            <div className="content-link-group flex flex-wrap gap-3 mt-4">
              ...
              <Link href="/faq" className="content-link-outline inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium border border-[var(--border)] text-[var(--foreground)] no-underline">
                Частые вопросы
              </Link>
            </div>
          </section>
