...
import { clearOldReadingPositions } from "../../lib/reading-position";
...
export default function ReadChapterPage({
  ...
  // Очистка старых позиций чтения при загрузке главы
  useEffect(() => {
    if (!titleId || !chapterId) return;

    // Очищаем старые позиции для данного тайтла, оставляя только текущую главу
    clearOldReadingPositions(titleId, chapterId);
  }, [titleId, chapterId]);
