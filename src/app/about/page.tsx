        ...
        <div className="w-full mx-auto px-2 min-[360px]:px-3 py-3 sm:px-4 sm:py-6 max-w-6xl min-w-0 overflow-x-hidden pb-12 sm:pb-16">
          ...
          <div className="content-page-hero text-center mb-10">
            ...
            <p className="text-[1.0625rem] text-[var(--muted-foreground)] max-w-3xl mx-auto leading-relaxed">
              ...
              каталог, персональный профиль, автоматическое сохранение прогресса и навигация на
              любых устройствах.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <section className="content-card bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 sm:p-8 sm:rounded-2xl">
              ...
              <p className="content-card-body text-[var(--muted-foreground)] leading-relaxed">
                Мы регулярно обновляем интерфейс, оптимизируем производительность и учитываем
                обратную связь. Главная, каталог, профиль и сервисные страницы развиваются как
                единая экосистема. Ваши предложения можно отправлять через страницу контактов.
              </p>
            </section>
