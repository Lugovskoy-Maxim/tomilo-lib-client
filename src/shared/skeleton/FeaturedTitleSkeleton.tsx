...
export const FeaturedTitleSkeleton: React.FC = () => (
  <section className="w-full" aria-label="Загрузка популярных тайтлов">
    <div className="relative w-full overflow-hidden">
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col min-h-[280px] sm:min-h-[340px] md:min-h-[420px] md:flex-row px-3 py-4 sm:px-6 sm:py-5 md:px-8 md:py-8 gap-3 sm:gap-5 md:gap-8">
        ...
        <div className="flex-1 flex flex-col justify-center min-w-0 text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-1.5 sm:gap-2 mb-2 sm:mb-3">
            <div className="h-5 sm:h-7 w-16 sm:w-20 rounded-md sm:rounded-lg bg-[var(--muted)] shimmer border border-[var(--border)]" />
            <div className="h-5 sm:h-7 w-14 sm:w-18 rounded-md sm:rounded-lg bg-[var(--muted)] shimmer border border-[var(--border)]" />
            <div className="h-5 sm:h-7 w-12 sm:w-14 rounded-md sm:rounded-lg bg-[var(--muted)] shimmer border border-[var(--border)]" />
            <div className="h-5 sm:h-7 w-14 sm:w-16 rounded-md sm:rounded-lg bg-[var(--muted)] shimmer border border-[var(--border)]" />
          </div>
          ...
          <div className="flex flex-wrap gap-1 sm:gap-1.5 mb-2 sm:mb-4 justify-center md:justify-start">
            <div className="h-5 sm:h-6 w-14 sm:w-16 rounded-md bg-[var(--muted)] shimmer border border-[var(--border)]" />
            <div className="h-5 sm:h-6 w-12 sm:w-14 rounded-md bg-[var(--muted)] shimmer border border-[var(--border)]" />
            <div className="h-5 sm:h-6 w-16 sm:w-20 rounded-md bg-[var(--muted)] shimmer border border-[var(--border)]" />
          </div>
          ...
          {/* Кнопки */}
          <div className="flex flex-wrap gap-1.5 sm:gap-3 justify-center md:justify-start mb-6 sm:mb-8">
            <div className="h-8 sm:h-11 w-20 sm:w-28 rounded-lg sm:rounded-xl bg-[var(--muted)] shimmer" />
            <div className="h-8 sm:h-11 w-24 sm:w-32 rounded-lg sm:rounded-xl bg-[var(--muted)] shimmer" />
            <div className="h-8 sm:h-11 w-24 sm:w-32 rounded-lg sm:rounded-xl bg-[var(--muted)] shimmer" />
          </div>
        </div>
      </div>
      ...
      {/* Индикаторы */}
      <div className="absolute bottom-0 left-0 right-0 pb-2 sm:pb-4">
        <div className="w-full max-w-7xl mx-auto flex justify-center">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <div className="h-1 sm:h-1.5 w-8 sm:w-10 rounded-full bg-[var(--muted)] shimmer" />
            <div className="h-1 sm:h-1.5 w-1.5 sm:w-2 rounded-full bg-[var(--muted-foreground)]/30" />
            <div className="h-1 sm:h-1.5 w-1.5 sm:w-2 rounded-full bg-[var(--muted-foreground)]/30" />
            <div className="h-1 sm:h-1.5 w-1.5 sm:w-2 rounded-full bg-[var(--muted-foreground)]/30" />
            <div className="h-1 sm:h-1.5 w-1.5 sm:w-2 rounded-full bg-[var(--muted-foreground)]/30" />
          </div>
