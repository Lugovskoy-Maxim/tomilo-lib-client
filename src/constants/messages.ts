...
export const MESSAGES = {
  ...
  UI_ELEMENTS: {
    ...
    LOGIN_SUBTITLE: "Войдите, чтобы сохранять закладки и историю",
    REGISTER_TITLE: "Создание аккаунта",
    REGISTER_SUBTITLE: "Заполните форму — это займёт минуту",
    NO_ACCOUNT: "Нет аккаунта?",
    HAVE_ACCOUNT: "Уже есть аккаунт?",
    FORGOT_PASSWORD_SENDING: "Отправка...",
    FORGOT_PASSWORD_SENT: "Письмо со ссылкой отправлено на вашу почту",
    USERNAME_PLACEHOLDER: "Как к вам обращаться",
