...
export function TitlesPageClient() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[var(--background)] via-[var(--background)] to-[var(--secondary)] relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10 w-full max-w-7xl mx-auto px-2 sm:px-3 lg:px-5 pb-20 md:pb-12">
        <TitlesContent />
      </main>
