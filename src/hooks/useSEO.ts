...
export const seoConfigs = {
  home: {
    ...
    description:
      "Большая коллекция манги, манхвы, маньхуа и комиксов для чтения онлайн бесплатно. Удобный интерфейс, регулярные обновления, закладки и история чтения.",
    keywords:
      "манга, маньхуа, комиксы, чтение онлайн, тайтлы, главы, манхва, бесплатно, онлайн, читать",
    type: "website" as const,
  },

  browse: (searchQuery?: string) => ({
    title: searchQuery
      ? `Поиск: "${searchQuery}" - Каталог манги, манхвы, маньхуа и комиксов - Tomilo-lib.ru`
      : "Каталог манги, манхвы, маньхуа и комиксов - Tomilo-lib.ru",
    description: searchQuery
      ? `Результаты поиска по запросу "${searchQuery}". Найдите интересующие вас тайтлы в нашем каталоге манги, манхвы, маньхуа и комиксов.`
      : "Обширный каталог манги, манхвы, маньхуа и комиксов для чтения онлайн. Поиск по жанрам, годам выпуска, статусу и типу. Удобная навигация и регулярные обновления.",
  ...
  title: (titleData: {
    ...
    return {
      ...
      publishedTime: titleData.releaseYear
        ? new Date(titleData.releaseYear, 0, 1).toISOString()
        : undefined,
    };
  },
  ...
  profile: (userName?: string) => ({
    title: userName
      ? `${userName} - Профиль | Tomilo-lib.ru`
      : "Профиль пользователя | Tomilo-lib.ru",
