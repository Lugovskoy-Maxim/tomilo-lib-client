    ...
    <main className="min-h-screen bg-gradient-to-br from-[var(--background)] to-[var(--secondary)]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-[var(--foreground)] mb-4">🛒 Магазин Tomilo</h1>
          <p className="text-lg text-[var(--muted-foreground)] max-w-2xl mx-auto">
            Персонализируйте свой профиль с помощью уникальных украшений. Выбирайте из аватаров,
            фонов и карточек, чтобы выделиться среди других пользователей.
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm text-[var(--muted-foreground)]">
              <div className="text-center">
                ...
                <p>
                  ...
                  <br />
                  Просмотрите доступные украшения в каждой категории
                </p>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">2️⃣</div>
                <p>
                  <strong>Купите за монеты</strong>
                  <br />
                  Используйте игровую валюту для покупки понравившихся товаров
                </p>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">3️⃣</div>
                <p>
                  <strong>Наденьте на профиль</strong>
                  <br />
                  Активируйте украшения, чтобы они отображались в вашем профиле
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <div className="bg-[var(--primary)]/10 border border-[var(--primary)]/20 rounded-lg p-4 max-w-md mx-auto">
            <p className="text-sm text-[var(--muted-foreground)]">
              💰 <strong>Монеты</strong> можно получить за активность на сайте, чтение манги и
