      ...
      <div className="flex items-center gap-3 hover:bg-[var(--muted)]/20 p-2 rounded-lg transition-colors">
        ...
        <div className="flex flex-col flex-1 gap-1">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xs text-[var(--muted-foreground)]">{translateTitleType(item.type)}</span>
            <span className="text-xs text-[var(--muted-foreground)]">•</span>
            <span className="text-xs text-[var(--muted-foreground)]">{item.year || "2025"}</span>
          </div>
          <h4 className="text-white font-medium group-hover:text-[var(--chart-1)]/80 transition-colors line-clamp-2">
            {item.title}
          </h4>
