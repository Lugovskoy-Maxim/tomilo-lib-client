        ...
        <div className="content-card mb-8">
          <div className="space-y-8">
            ...
            <div>
              ...
              <ol className="content-card-body list-decimal list-inside space-y-1">
            ...
            <div>
              ...
              <p className="content-card-body mb-4">{currentContent.counterNoticeText}</p>
              <ol className="content-card-body list-decimal list-inside space-y-1">
            ...
            <div className="flex items-start gap-3 p-4 bg-[var(--accent)] rounded-lg">
              ...
              <p className="content-card-body mb-0">{currentContent.processingTime}</p>
            </div>
